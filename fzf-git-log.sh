...
function fzf_git_log() {
	...
	# git-delta
	local DELTA_OPTIONS="--dark --syntax-theme=none --side-by-side --line-numbers --tabs=4 --hyperlinks --commit-style=omit --hunk-header-decoration-style='blue ul'"
	local DELTA_SYNTAX="\
		--line-numbers-zero-style='#CDD6F4' \
		--line-numbers-minus-style='#F38BA8' \
		--line-numbers-plus-style='#A6E3A1' \
		--minus-style='#F38BA8' \
		--plus-style='#A6E3A1' \
		--minus-emph-style='#F38BA8' \
		--plus-emph-style='#A6E3A1' \
		"
